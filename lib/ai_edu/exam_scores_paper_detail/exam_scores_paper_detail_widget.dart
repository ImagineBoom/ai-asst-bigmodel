...
class _ExamScoresPaperDetailWidgetState
  ...
  void initState() {
    ...
    _model.textField2TextController ??=
        TextEditingController(text: FFAppState().paperContent);
    _model.textField2FocusNode ??= FocusNode();
    _model.textField2FocusNode!.addListener(() => safeSetState(() {}));
    _model.textField3TextController ??=
        TextEditingController(text: FFAppState().teacherComment);
