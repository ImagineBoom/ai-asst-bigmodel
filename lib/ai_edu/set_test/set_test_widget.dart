...
import 'set_test_model.dart';
export 'set_test_model.dart';

class SetTestWidget extends StatefulWidget {
  const SetTestWidget({
    super.key,
  ...
  @override
  State<SetTestWidget> createState() => _SetTestWidgetState();
}

class _SetTestWidgetState extends State<SetTestWidget> {
  late SetTestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SetTestModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final setTestListResponse = snapshot.data!;
                                                      ...
                                                      FFButtonWidget(
                                                        onPressed: () async {
                                                          _model.apiResultri8 =
                                                            ...
                                                            id: widget!
                                                                .asstExamBankID,
                                                            standardAnswer: _model
                                                                .answerTextFieldTextController
                                                                .text,
                                                            questionContent: _model
